...
Written 2026-08-11. Earlier prompts produced small rugs in modest rooms.

**Why this one is different.** A 15m × 10m commission is a very large purchase, and the
imagery has to fish for that buyer. Scale is created by four
...
```
A single enormous bespoke hand-woven wool rug, approximately 15 metres by 10
...
- Endpoint: `POST https://openrouter.ai/api/v1/images`, key `OPENROUTER_API_KEY` in `.env`
